<?php
	return
		$word = [
			...
			'pass_not_much' => 'The passwords do not match',
			'login_too_short' => 'Login must contains more than 4 words',
			'pass_too_short' => 'Pass must contains more than 6 words',
